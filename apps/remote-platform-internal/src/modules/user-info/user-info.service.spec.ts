...
describe('UserInfoService (Internal)', () => {
          ...
          ticketTemplateList: [
            {
              ...
              titlePrefix: '[Bug]',
              epicTicket: 'PROJ-1',
              assigneeInfoList: [{ username: 'dev1', displayName: 'Dev One', email: 'd@e.com' }],
  ...
  describe('getTicketFormDataByTemplate', () => {
    it('should return data for specific template', async () => {
      ...
      const result = await service.getTicketFormDataByTemplate('device-1', 'Feature');
    ...
    it('should throw when template not found', async () => {
      ...
      await expect(service.getTicketFormDataByTemplate('device-1', 'NonExistent')).rejects.toThrow(
