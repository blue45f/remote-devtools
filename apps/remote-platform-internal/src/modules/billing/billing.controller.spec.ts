...
describe("BillingController", () => {
  ...
  describe("subscription", () => {
    ...
    it("rejects requests without authenticated org context", async () => {
      await expect(controller.subscription(null)).rejects.toThrow(
        BadRequestException,
      );
    });
  });
  ...
  describe("portal", () => {
    ...
    it("requires an authenticated org context", async () => {
      await expect(controller.portal(null, validBody)).rejects.toThrow(
        BadRequestException,
      );
    });
  ...
  describe("webhook", () => {
    ...
    it("propagates handleWebhook errors", async () => {
      mockBilling.handleWebhook.mockRejectedValueOnce(
